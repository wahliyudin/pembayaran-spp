...
class TarifPembayaranJurusanComponent extends Component
{
    use LivewireAlert;
    public $monthly = [];
    ...
    {
        return view('livewire.admin.tarif-pembayaran-jurusan-component', [
            'months' => Month::get(),
    ...
    {
        $this->majors = Major::latest()->get();
    }

    public function create()
    {
        try {
            $students = Student::with('monthly')->where('major_id', $this->major_id)->get();
